 ...
 * @author kcfurtado
 */
public class AlterTituloLivro extends javax.swing.JFrame {

    /**
     * Creates new form MenuCliente
     */
    public AlterTituloLivro() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel1.setText(" Actual Titulo");

        jLabel3.setText(" Novo ISBN");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(AlterTituloLivro.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
